...
export default {
    ...
    methods: {
        ...
        confirmRecDetails(rec) {
            ...
            this.rec_details.repondeur = this.reponses.find(reponse => reponse.rec_id === rec.id).repondeur;
            this.rec_details.reponse = this.reponses.find(reponse => reponse.rec_id === rec.id).reponse;
        ...
        updateRec() {
            ...
            this.form.post(route('reclamations.update'),{
                ...
                onSuccess: () => {
                    this.closeModal()
                    this.closeModal2()
                    this.swalAlert('La Reclamation a été cloturé')
                },
            })
...
<template>
        ...
        <template #header>
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <h2 class="text-xl font-semibold leading-tight ml-8">
                    Liste des Reclamations ( Traitement Fini )
                </h2>
            </div>
        </template>
        ...
        <div>
            <div class="max-w-6xl mx-auto py-7 sm:px-6 lg:px-8">
                ...
                <div class="block mt-8">
                    <a href="#" @click="cloturer(this.rec_details)" class="bg-green-200 hover:bg-green-300 text-black font-bold py-2 px-4 rounded">Cloturer</a>
                </div>
    ...
    <Modal :show="cloturing" @close="closeModal2">
        <div class="p-6">
            <h2
                class="text-lg font-medium text-gray-900 dark:text-gray-100"
            >
                Êtes-vous sûr de vouloir Cloturer Cette Reclamation ?
            </h2>
