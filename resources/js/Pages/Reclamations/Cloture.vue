        ...
        <template #header>
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <h2 class="text-xl font-semibold leading-tight ml-8">
                    Liste des Reclamations cloturées
                </h2>
            </div>
        </template>
                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 dark:border-gray-500 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-500 dark:divide-gray-500 w-full">
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="whitespace-pre-wrap break-words px-6 py-4 whitespace-nowrap text-sm text-gray-900 bg-white divide-y divide-gray-200 dark:divide-gray-500 dark:divide-gray-500">
